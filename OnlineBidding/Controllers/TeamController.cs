...
namespace OnlineBidding.Controllers
{
    public class TeamController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="ID,Name,Description,Disqualified")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="ID,Name,Description,Disqualified")] Team team)
        {
            if (ModelState.IsValid)
            {
